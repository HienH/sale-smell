          ...
          <section className='mb-12'>
            <div className='text-center mb-8'>
              ...
              <p className='mt-2 text-gray-600'>
                Get instant analysis and coaching insights from your recorded
                sales conversations
              </p>
            </div>
          ...
          {state.transcription && (
            <section className='mb-12'>
              <div className='bg-white rounded-lg shadow-lg p-8'>
                ...
                {state.transcription.speakers &&
                  state.transcription.speakers.length > 0 && (
                    <div className='mb-8'>
                          ...
                          <div className='flex items-center justify-between'>
                            ...
                            <svg
                              className={`w-5 h-5 text-gray-500 transform transition-transform duration-200 ${
                                state.isSpeakerNamesOpen ? 'rotate-180' : ''
                              }`}
                              fill='none'
                              stroke='currentColor'
                              viewBox='0 0 24 24'
                      ...
                      <div className='space-y-4'>
                        {state.transcription.speakers.map((segment, index) => {
                          ...
                          const sentimentSegment =
                            state.transcription?.sentiment?.segments?.find(
                              s => {
                                // Match by timing with some tolerance
                                const timeOverlap =
                                  Math.abs(s.start - segment.start) < 1000 &&
                                  Math.abs(s.end - segment.end) < 1000;
                                // Or match by text content
                                const textMatch =
                                  s.text
                                    .toLowerCase()
                                    .includes(segment.text.toLowerCase()) ||
                                  segment.text
                                    .toLowerCase()
                                    .includes(s.text.toLowerCase());
                          ...
                          return (
                            <div key={index} className='space-y-2'>
                              <div className='flex items-start space-x-3'>
                                ...
                                >
                                  {segment.speaker === 'A'
                                    ? state.speakerNames.A || 'Speaker A'
                                    : state.speakerNames.B || 'Speaker B'}
                                </span>
                                {sentimentSegment && (
                                  <span
                                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                ...
                {/* Sentiment Analysis */}
                {state.transcription.sentiment &&
                  state.transcription.sentiment.segments && (
                    <div className='mb-8'>
                      <h3 className='text-lg font-medium text-gray-900 mb-4'>
                        Sentiment Analysis
                      </h3>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-4'>
                          <div className='bg-green-50 rounded-lg p-4'>
                            <div className='text-2xl font-bold text-green-600'>
                              {
                                state.transcription.sentiment.segments.filter(
                ...
                {/* PII Redaction */}
                {state.transcription.piiRedactions &&
                  state.transcription.piiRedactions.length > 0 && (
                    <div className='mb-8'>
                      <h3 className='text-lg font-medium text-gray-900 mb-4'>
                        Privacy Protection
                      </h3>
                      <div className='bg-orange-50 rounded-lg p-4'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
                          {state.transcription.piiRedactions.map(
                            (redaction, index) => (
                              <div
                                key={index}
                              ...
                              >
                                <div className='flex items-center justify-between mb-2'>
                                  <span
                                    className={`px-2 py-1 rounded text-xs font-medium ${
                                      redaction.type === 'PERSON_NAME'
                                        ? 'bg-blue-100 text-blue-800'
                                        : redaction.type === 'EMAIL_ADDRESS'
                                          ? 'bg-green-100 text-green-800'
                                          : redaction.type === 'PHONE_NUMBER'
                        ...
                        <p className='text-sm text-orange-700 mt-3'>
                          🔒 Your privacy is protected. Personal information has
                          been automatically detected and redacted from the
                          transcript.
                        </p>
                      </div>
                    </div>
                ...
                {/* Key Highlights */}
                {state.transcription.autoHighlights &&
                  state.transcription.autoHighlights.length > 0 && (
                    <div className='mb-8'>
                      <h3 className='text-lg font-medium text-gray-900 mb-4'>
                        Key Highlights
                      </h3>
                      <div className='bg-yellow-50 rounded-lg p-4'>
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
                          {state.transcription.autoHighlights.map(
                            (highlight, index) => (
                              <div
                                key={index}
                        ...
                        <p className='text-sm text-yellow-700 mt-3'>
                          ⭐ These are the most important moments and phrases
                          detected in your call.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className='bg-success-50 border border-success-200 rounded-lg p-4'>
                    <div className='flex items-center'>
                      ...
                      <span className='text-success-800 font-medium'>
                        Analysis complete! Download your report for detailed
                        insights.
                      </span>
                    </div>
                  </div>
            ...
            <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3'>
              ...
              <div className='card p-6'>
                ...
                <p className='text-gray-600'>
                  Accurate speech-to-text with speaker identification and
                  sentiment analysis
                </p>
              </div>
              ...
              <div className='card p-6'>
                ...
                <p className='text-gray-600'>
                  Deep insights into objection handling, talk time, and coaching
                  opportunities
                </p>
              </div>
              ...
              <div className='card p-6'>
                ...
                <p className='text-gray-600'>
                  Download comprehensive PDF reports with actionable coaching
                  feedback
                </p>
              </div>
            </div>
